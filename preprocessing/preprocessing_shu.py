...
root_dir = r'../Raw_data/SHU-MI/SHU-MI'
...
os.makedirs("../processed_data/shu_datasets/processed",exist_ok=True)
db = lmdb.open(r'../processed_data/shu_datasets/processed', map_size=10 * 1024 * 1024 * 1024) #10GB   初始:110612736
